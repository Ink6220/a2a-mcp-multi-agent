...
from a2a_mcp.common.prompts import PRESALE_PROMPT, PROMO_ADVISOR_PROMPT, GUIDE_PROMPT, PLAN_PROMPT, RECOMMEND_PROMPT
...
def get_agent(agent_card: CustomAgentCard, card_discovery: A2ACardDiscovery, mcp_server: FilteredMCPServerSse):
    ...
    try:
        ...
        elif agent_card.name == "Guide Agent":
            agent_card.systemPrompt = GUIDE_PROMPT
        elif agent_card.name == "Plan Agent":
            agent_card.systemPrompt = PLAN_PROMPT
        elif agent_card.name == "Recommend Agent":
            agent_card.systemPrompt = RECOMMEND_PROMPT
